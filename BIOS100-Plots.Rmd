...
The function left_join() is used to join the second data set to the first. It keeps all of the rows from the first data set, in this case Plant Diversity. It looks for any rows in the second data set with the same values for the field listed in "by", in this case plotID. If a plotID is missing from the second data set, the entry will be listed as NA.
